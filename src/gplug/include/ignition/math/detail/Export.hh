...
#    ifdef ignition_math4_EXPORTS
        /* We are building this library */
#      define DETAIL_IGNITION_MATH_VISIBLE __attribute__((visibility("default")))
#    else
...
#    define DETAIL_IGNITION_MATH_HIDDEN __attribute__((visibility("hidden")))
#  endif
#endif
